...
//A) Para realizar a mudança necessária, criaria uma classe abstrata persistencia.
// Cada classe unica que correspondesse ao modo de armazenar o dado entao herda da classe persistencia que ja possui os metodos de inserir excluir listar e buscar
// Desse modo sempre que um novo modo de armazenar for solicitado seria necessario criar uma classe nova e herdar a persistencia.
// As modificações da estrutura do aplicativo seriam poucas facilitando a transição
// Creio que essa é a melhor maneira de resolver o problema.

//B) Para salvar um objeto bastar chamar o metodo estatico do modo como queria salvar e passar o objeto como parametro.
